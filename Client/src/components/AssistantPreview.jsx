  ...
  return (
    <div className="flex items-center justify-center px-3 sm:px-4 py-10 sm:py-14">
      ...
      >
        ...
        {/* Theme Container  */}
        <div className="flex items-center gap-2 absolute top-4 right-4 sm:top-5 sm:right-5 z-30">
          {/* Dark theme */}
          <button
        ...
        <div className="relative flex flex-col z-20 items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8 ">
            {/* Animate part */}
            <div className="relative mt-1">
                <div
                className={`absolute inset-0 scale-[2] rounded-full blur-[80px] bg-linear-to-r ${current.orb} opacity-60`}
                />

                <div
                className={`relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full bg-linear-to-r ${current.orb} shadow-[0_0_120px_rgba(255,255,255,0.25)] animate-pulse before:bg-white/20 before:blur-xl`}
                />
            </div>
            {/* Animate part end */}
            ...
            <div className="text-center">
                ...
                {/* Animate Listening end*/}
            </div> 

          <div className="relative mb-1">
            {/* Microphone glow behind the button */}
            <div
            ...
            <button
              className={`relative flex items-center justify-center w-12 h-12 sm:w-15 sm:h-15 md:w-18 md:h-18 rounded-full bg-linear-to-br ${current.button} ${current.micGlow} `}
            >
